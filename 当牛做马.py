...
#
#         # 缩放限制
#         self.min_scale = 0.5  # 最小缩小到 50%
#         self.max_scale = 2.0  # 最大放大到 200%
#         self.min_font_size = 6  # 字体最小不能小于 6号
#         self.max_font_size = 100  # 字体最大不能超过 100号
#
...
#         self.total_label.pack(pady=(0, 0))
...
#                                    anchor="center")
#         self.info_label.pack(fill="x", padx=15, pady=(0, 15))
...
#
#         if is_working:
#             self.money_label.config(text=f"¥ {earned_today:.2f}")
#         else:
...
#                 self.money_label.config(text=f"¥ {earned_today:.2f}")
#
#         self.total_label.config(text=f"月挣：¥ {total_earned_month:.2f}")
